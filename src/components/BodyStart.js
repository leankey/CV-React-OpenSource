...
import './BodyStart.css';


class BodyStart extends React.Component {
    render() {
        return (
            <div>
            <div className="bg-image-body-container">
                <img src={this.props.background} className="bg-image" alt="Background"></img>
                <div className="profile-container">
                   <img src={this.props.myPhoto} className="myPhoto"/>
                   <h1 className="profile-name">{this.props.name}
                   </h1>
                   <hr className="sub-name-hr"/>
                <h4 className="role">{this.props.role}</h4>
                <div className="link-container">
                    <a href={this.props.inst} target="_blank">
                    ...
                    <a id="about" href={this.props.telegram} target="_blank">
